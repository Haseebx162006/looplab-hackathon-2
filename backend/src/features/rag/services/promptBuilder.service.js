export function buildPrompt({
  ...
  const lengthInstruction =
    brevity > 0.7 ? 'Be very concise and direct.' : brevity < 0.3 ? 'Provide detailed explanations.' : 'Keep responses balanced and informative.';

  const toneInstruction =
    formality > 0.7 ? 'Use formal and professional tone.' : formality < 0.3 ? 'Use casual, friendly, and conversational tone.' : 'Use professional yet approachable tone.';
